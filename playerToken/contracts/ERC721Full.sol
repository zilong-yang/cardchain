...
contract ERC721 is ERC165, IERC721 {
    ...
    /**
     *@dem Change the stat values of a given token 
     * 
     */
    function _changeStats(uint256 tokenId, uint8[3] memory statPoints) internal {
    ...
    function _getStats(uint256 tokenId) public view returns (uint8[] memory){
        ...
        statsArray[2] = _tokenStats[tokenId].elusive;
